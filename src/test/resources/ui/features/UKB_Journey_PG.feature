Feature: UK Breakdown Journey
  ...
  Scenario: UK Breakdown Journey with Parts and Garage
    ...
    And I click the "partsGarageCover" on the "OptionPage"
    When I wait "2" seconds to synchronize the things on app
    And I enter the value "J4J HS" into the "vehicleRegistrationNumber" on the "OptionPage"
    And I click the "partsAndGarageBtn" on the "OptionPage"
